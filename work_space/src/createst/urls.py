...
from .views import IndexView, LoginView, ShowQuizView, CreateTestView, SignupView, LogoutView, UserView, OtherView,ChangeUsernameView,ChangeEmailView,ChangePasswordView, IndexTestView
from . import views
