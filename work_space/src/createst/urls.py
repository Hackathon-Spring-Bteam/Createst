...
from .views import IndexView, LoginView, ShowQuizView, CreateTestView, SignupView, LogoutView, UserView, OtherView, ChangeUsernameView, ChangeEmailView, ChangePasswordView
from . import views
